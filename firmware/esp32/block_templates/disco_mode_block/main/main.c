// Skeleton firmware for DISCO_MODE block template.
...
#define BLOCK_NAME            "DISCO"
#define BLOCK_I2C_ADDRESS     0x08  // TODO: set per board
#define BLOCK_TYPE            BLOCK_TYPE_DISCO

static const char *TAG = "TPL_DISCO";

// ============================================================================
// CONFIG (payload: mode_id)
// ============================================================================
typedef struct {
    uint8_t mode_id; // TODO: rhythm/tempo mode
} block_config_t;
