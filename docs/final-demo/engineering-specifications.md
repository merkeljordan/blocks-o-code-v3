...
| **Definition**     | Time for the selected I2C line to transition from low to high (typically 10% to 90% of Vdd), measured at the Brain Block's I2C header with the fully populated bus (15 blocks total). |
...
- Use an oscilloscope to probe SCL (or SDA) at the Brain Block, with the normal pull-up resistors and all 14 child blocks connected (15 blocks total).
