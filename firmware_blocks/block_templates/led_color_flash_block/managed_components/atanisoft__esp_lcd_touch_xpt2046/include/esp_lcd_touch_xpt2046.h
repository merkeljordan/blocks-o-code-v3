 ...
 *
 * @param handle: XPT2046 instance handle.
 * @param output: Approximate temperature of the TSC2046 in degrees C.
 * @return
 *      - ESP_OK on success, otherwise returns ESP_ERR_xxx
 */
esp_err_t esp_lcd_touch_xpt2046_read_temperature_c(const esp_lcd_touch_handle_t handle, float *output);
 ...
 *      - ESP_OK on success, otherwise returns ESP_ERR_xxx
 */
esp_err_t esp_lcd_touch_xpt2046_read_temperature_c2(const esp_lcd_touch_handle_t handle, float *output);
