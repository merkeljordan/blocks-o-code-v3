 ...
 * @brief Per-block battery ADC calibration constants for led_color_flash_block.
 *
 * These calibration values are specific to the led_color_flash_block PCB and account for
 ...
 */
#define BATTERY_CAL_SCALE 0.998f
