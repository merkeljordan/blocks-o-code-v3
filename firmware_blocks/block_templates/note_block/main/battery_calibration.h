 ...
 * @brief Per-block battery ADC calibration constants for note_block.
 *
 * These calibration values are specific to the note_block PCB and account for
 ...
 */
#define BATTERY_CAL_SCALE 0.985f
