 ...
 * @brief Per-block battery ADC calibration constants for note_block_3.
 *
 * These calibration values are specific to the note_block_3 PCB and account for
 ...
 */
#define BATTERY_CAL_SCALE 1.000f
