 ...
 * @brief Per-block battery ADC calibration constants for music_sequence_block.
 *
 * These calibration values are specific to the music_sequence_block PCB and account for
 ...
 */
#define BATTERY_CAL_SCALE 1.01f
