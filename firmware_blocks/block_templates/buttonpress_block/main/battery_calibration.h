 ...
 * @brief Per-block battery ADC calibration constants for buttonpress block.
 *
 * These calibration values are specific to the buttonpress block PCB and account for
