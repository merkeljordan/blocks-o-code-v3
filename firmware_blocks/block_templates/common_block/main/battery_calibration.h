 ...
 * @brief Per-block battery ADC calibration constants for common block template.
 *
 * These calibration values are specific to the common block PCB and account for
