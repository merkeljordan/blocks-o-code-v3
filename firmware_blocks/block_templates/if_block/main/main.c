...
<<<<<<< HEAD
    led_contract_rgb_t identity = led_contract_identity_color(BLOCK_TYPE_IF);
    animate_control_flow_pulse(identity, 2U, 90U, 45U);
=======
    // Simple "running" indication: brief blue flash on the matrix.
    matrix_fill(0, 0, 64);
    matrix_show();
...
// ============================================================================
uint8_t if_block_get_status_flags(void)
{
...
>>>>>>> origin/main
        ...
        case CMD_GET_DATA:
            // IF block has no payload; return zero-length response.
            break;
