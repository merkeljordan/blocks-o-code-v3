 ...
 * @brief Per-block battery ADC calibration constants for delay block.
 *
 * These calibration values are specific to the delay block PCB and account for
 ...
 */
#define BATTERY_CAL_SCALE 0.994f
