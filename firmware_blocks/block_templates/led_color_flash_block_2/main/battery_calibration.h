 ...
 * @brief Per-block battery ADC calibration constants for led_color_flash_block_2.
 *
 * These calibration values are specific to the led_color_flash_block_2 PCB and account for
 ...
 */
#define BATTERY_CAL_SCALE 0.997f
