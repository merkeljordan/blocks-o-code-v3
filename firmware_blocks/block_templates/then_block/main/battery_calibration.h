 ...
 * @brief Per-block battery ADC calibration constants for then block.
 *
 * These calibration values are specific to the then block PCB and account for
 ...
 */
#define BATTERY_CAL_SCALE 0.992f
